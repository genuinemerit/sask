...
def build_reference(app) -> tuple[str, str]:
    ...
    data = {
        "generated_by": "tools/dev/build_api_reference.py (SPEC-040, DD-0027)",
...
<p class="meta">Generated by tools/dev/build_api_reference.py (DD-0027, SPEC-040). Developer/AI-assistant facing, English-only. Never hand-edited — see docs/api_reference_src/reference.toml.</p>
